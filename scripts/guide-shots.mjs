...
const SHOTS = [
  ...
  ["titres-client", "/", { prep: "localStorage.setItem('guichet:onboarded','1'); localStorage.setItem('guichet:presented','1'); localStorage.setItem('guichet:coach:titres','1'); setTimeout(() => location.reload(), 0); 'ok'", settle: 3000, maxHeight: 1100 }],
  ["fonds-client", "/fonds", { prep: "localStorage.setItem('guichet:onboarded','1'); localStorage.setItem('guichet:presented','1'); localStorage.setItem('guichet:coach:fonds','1'); setTimeout(() => location.reload(), 0); 'ok'", settle: 3000, maxHeight: 1100 }],
  ["parcours-client", "/info/parcours", { prep: "localStorage.setItem('guichet:onboarded','1'); localStorage.setItem('guichet:presented','1'); localStorage.setItem('guichet:coach:parcours','1'); setTimeout(() => location.reload(), 0); 'ok'", settle: 3000, maxHeight: 1400 }],
  ["lecon-carte", "/info/tresors-svt", { prep: "localStorage.setItem('guichet:onboarded','1'); localStorage.setItem('guichet:presented','1'); setTimeout(() => location.reload(), 0); 'ok'", settle: 3000, maxHeight: 1500 }],
  ["info-client", "/info", { prep: "localStorage.setItem('guichet:onboarded','1'); localStorage.setItem('guichet:presented','1'); localStorage.setItem('guichet:coach:info','1'); setTimeout(() => location.reload(), 0); 'ok'", settle: 3000 }],
  ["onboarding-info", "/info", { width: 390, height: 780, prep: "localStorage.setItem('guichet:onboarded','1'); localStorage.setItem('guichet:presented','1'); localStorage.setItem('guichet:coach:info','1'); setTimeout(() => location.reload(), 0); 'ok'", settle: 3000 }],
  ["onboarding-aide", "/info/aide", { width: 390, height: 780, prep: "localStorage.setItem('guichet:onboarded','1'); localStorage.setItem('guichet:presented','1'); localStorage.setItem('guichet:coach:aide','1'); setTimeout(() => location.reload(), 0); 'ok'", settle: 3000 }],
  ["premiers-pas", "/info?premiers-pas=1", { width: 390, height: 844, prep: "localStorage.setItem('guichet:onboarded','1'); localStorage.setItem('guichet:presented','1'); setTimeout(() => location.reload(), 0); 'ok'", settle: 5000, then: "await new Promise(r=>setTimeout(r,800)); const d=[...document.querySelectorAll('[role=dialog]')].pop(); for (let k=0;k<4;k++){ [...d.querySelectorAll('button')].find(b=>/Continuer|Continue/.test(b.textContent))?.click(); await new Promise(r=>setTimeout(r,450)); } await new Promise(r=>setTimeout(r,600)); 'ok'" }],
