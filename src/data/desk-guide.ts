...
export const GUIDE: GuideSection[] = [
  ...
  },
  {
    ...
    shots: [
      { key: "titres-client", caption: "Ce que le client voit sur un écran large : la page Titres, ses deux interrupteurs de marché (primaire, secondaire) et le lien vers les fonds" },
      { key: "fonds-client", caption: "La page Fonds sur un écran large : un tableau, les quatre catégories expliquées au-dessus" },
      { key: "titres-phone", caption: "Sur le téléphone : les cartes, le statut et le « ··· » dans le coin, les trois faits (la durée sous l'échéance), « Voir la fiche » en pied ; en bas, l'icône des filtres et le chevron" },
      { key: "titres-compact", caption: "Les cartes compactes, ici avec la distinction « alternée + demi-trait » : deux lignes par ligne, le titre, puis le chiffre, sa condition et la clôture" },
      { key: "carte-actions", caption: "Une carte tirée vers la gauche : « Déclarer » (le formulaire de la fiche) et « Me rappeler » (un rappel avant la clôture) ; la poignée « ‹ » referme" },
      { key: "carte-dos", caption: "Une carte tirée vers la droite se retourne : la courbe (ou le calendrier de l'opération), les faits datés, le calcul de référence de la fiche" },
      { key: "fonds-phone", caption: "Les fonds en cartes sur le téléphone : catégorie, périodicité, société de gestion, la VL en grand, douze mois, depuis l'origine, variation" },
      { key: "fonds-dos", caption: "Le dos d'une carte de fonds en vue compacte : les chiffres de la liste, les dernières VL, la prochaine VL, pour 1 000 000 FCFA à la dernière VL" },
      { key: "menu-ligne", caption: "Le « ··· » d'une ligne : voir la fiche, suivre, comparer avec, partager le lien, copier l'ISIN ; jamais « Déclarer une intention », qui reste un bouton" },
      { key: "affichage-cartes", caption: "« Affichage des cartes » : la densité et huit façons de distinguer une carte de la suivante, gardées sur l'appareil" },
      { key: "fiche-phone", caption: "La fiche sur le téléphone : glisser vers la gauche ou la droite passe à la ligne suivante ou précédente de la liste ; le « ··· » du haut porte le partage et le PDF" },
    ],
  },
  {
    key: "actualites",
  ...
  },
  {
    ...
    shots: [
      ...
      { key: "info-client", caption: "La page Guide du client : recherche, aide, leçons, simulateur, glossaire" },
