      ...
      blocks: [
        {
          ...
          rows: [
            ...
            [l("Quels gestes sur le téléphone ?", "Which gestures on the phone?"), l("Sur une fiche, glissez vers la gauche ou la droite pour passer à la ligne suivante ou précédente de votre liste ; les flèches « Précédente » et « Suivante » font pareil. Le « ··· » d'une ligne, ou un appui long dessus, ouvre les actions : voir la fiche, suivre, comparer, partager le lien, copier l'ISIN. Une feuille se ferme en la tirant vers le bas ou en touchant à côté.", "On a line's page, swipe left or right to move to the next or previous line of your list; the \"Previous\" and \"Next\" arrows do the same. The \"···\" of a line, or a long press on it, opens its actions: view details, follow, compare, share the link, copy the ISIN. A sheet closes when pulled down or when you tap beside it.")],
          ],
        },
      ],
    },
