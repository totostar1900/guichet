      ...
      blocks: [
        {
          ...
          rows: [
            [l("Où est mon mot de passe ?", "Where is my password?"), l("Il n'y en a pas. Vous recevez un code à six chiffres par e-mail ; il vaut dix minutes, le dernier reçu est toujours le bon. Et sur un appareil que vous avez ajouté, un doigt (Face ID, empreinte, code du téléphone) ou quatre chiffres suffisent : le code e-mail reste toujours possible dessous.", "There is none. You receive a six-digit code by e-mail; it is valid ten minutes, the latest received is always the right one. And on a device you have added, a finger (Face ID, fingerprint, the phone's code) or four digits are enough: the e-mail code always remains possible below.")],
            [l("Comment ouvrir d'un doigt la prochaine fois ?", "How do I open with a finger next time?"), l("Mon espace › Sécurité › Ajouter cet appareil. Deux façons : la serrure de votre téléphone (Face ID, empreinte ou son code : rien à retenir, rien à voler), ou un code à quatre chiffres lié à ce navigateur (il n'ouvre rien ailleurs). Vous pouvez retirer un appareil à tout moment ; chaque ajout et chaque retrait vous sont annoncés par e-mail et sur WhatsApp.", "My space › Security › Add this device. Two ways: your phone's lock (Face ID, fingerprint or its code: nothing to remember, nothing to steal), or a four-digit code bound to this browser (it opens nothing elsewhere). You can remove a device at any time; every addition and every removal is announced to you by e-mail and on WhatsApp.")],
            [l("J'ai tapé cinq fois un mauvais code à quatre chiffres", "I typed a wrong four-digit code five times"), l("L'appareil est oublié, par prudence. Connectez-vous par le code e-mail, puis ajoutez-le à nouveau depuis Sécurité.", "The device is forgotten, out of caution. Sign in with the e-mail code, then add it again from Security.")],
            ...
            [l("J'ai changé d'adresse e-mail ou de numéro", "I changed my e-mail address or number"), l("Un nouveau numéro se prouve à nouveau : dans Sécurité ou à la prochaine intention, un code arrive sur WhatsApp, une seule fois. Une nouvelle adresse : connectez-vous avec elle, par son code ; dites-le-nous et le desk rattache vos intentions.", "A new number is proven again: in Security or with the next intention, a code arrives on WhatsApp, once. A new address: sign in with it, by its code; tell us and the desk carries your intentions over.")],
            ...
            [l("Où sont l'aide, le contact et les réglages ?", "Where are help, contact and settings?"), l("Derrière le « ⋮ » en haut à droite, sur chaque page, en trois onglets. Aide : une recherche qui fouille cette aide, le glossaire et les leçons, les repères de la page, les deux animations d'accueil, vos deux parcours avec leur avancement, les trois questions les plus posées. Contact : WhatsApp (depuis une fiche, le message part avec le nom de la ligne), appel, e-mail, les mentions. Réglages : la langue, l'affichage des cartes, les alertes, votre profil financier, Sécurité et Se déconnecter une fois connecté. Le « ··· » d'une ligne, lui, ne parle que de cette ligne.", "Behind the \"⋮\" at the top right, on every page, in three tabs. Help: a search over this help, the glossary and the lessons, the page's landmarks, the two welcome animations, your two courses with their progress, the three most asked questions. Contact: WhatsApp (from a line's page, the message leaves with the line's name), call, e-mail, the terms. Settings: the language, the card display, the alerts, your financial profile, Security and Sign out once signed in. A line's \"···\" speaks only of that line.")],
            [l("Quels gestes sur le téléphone ?", "Which gestures on the phone?"), l("Sur une fiche, glissez vers la gauche ou la droite pour passer à la ligne suivante ou précédente de votre liste ; les flèches « Précédente » et « Suivante » font pareil. Sur une liste, tirez une carte vers la gauche : « Déclarer » et « Me rappeler » apparaissent dessous (un long tirage déclare d'un coup) ; tirez-la vers la droite : elle se retourne et montre le calendrier ou la courbe de la ligne, puis le calcul de référence. Pour revenir : tirez dans l'autre sens, touchez le dos ou ailleurs, ou faites défiler. Les deux icônes à droite du tri choisissent des cartes détaillées ou compactes. Le « ··· » d'une ligne ouvre ses actions : voir la fiche, suivre, comparer, partager le lien, copier l'ISIN. Sur la page des fonds, le bouton « Filtrer · Trier » en bas ramène les filtres sans remonter. Une feuille se ferme en la tirant vers le bas ou en touchant à côté.", "On a line's page, swipe left or right to move to the next or previous line of your list; the \"Previous\" and \"Next\" arrows do the same. On a list, pull a card to the left: \"Declare\" and \"Remind me\" appear under it (a long pull declares at once); pull it to the right: it turns over and shows the line's calendar or curve, then the reference calculation. To come back: pull the other way, tap the back or elsewhere, or scroll. The two icons beside the sort choose detailed or compact cards. The \"···\" of a line opens its actions: view details, follow, compare, share the link, copy the ISIN. On the funds page, the \"Filter · Sort\" button at the bottom brings the filters back without scrolling up. A sheet closes when pulled down or when you tap beside it.")],
          ],
        },
      ],
    },
      ...
      blocks: [
        {
          ...
          rows: [
            ...
            [l("Par où commencer si je ne connais rien au marché ?", "Where do I start if I know nothing about the market?"), l("Le Guide propose deux parcours. « Lire une ligne en trente secondes » : huit leçons de deux minutes pour comprendre une fiche. « Comprendre le marché CEMAC » : six sections repliables et vingt-huit leçons, le marché et ses acteurs, les instruments, les risques, passer un ordre, fiscalité et frais, taux et monnaie, chacune avec un schéma ou un bloc à manipuler, une question, et les mots du glossaire. Le parcours retient où vous en êtes.", "The Guide offers two courses. \"Reading a line in thirty seconds\": eight two-minute lessons to understand a line's page. \"Understanding the CEMAC market\": six folding sections and twenty-eight lessons, the market and its actors, the instruments, the risks, placing an order, tax and fees, rates and money, each with a diagram or a block to play with, a question, and the glossary words. The course remembers where you are.")],
            [l("Comment retrouver un mot du glossaire ?", "How do I find a glossary word?"), l("En bas du Guide, « Les mots du Guichet » a sa propre recherche, un tri A → Z ou par catégorie, et un regroupement par catégorie (titres de dette, actions et sociétés, fonds, vos ordres, les états d'une ligne). La recherche du haut de page trouve aussi chaque mot, et chaque bulle « i » de l'application y renvoie.", "At the bottom of the Guide, \"The Guichet's words\" has its own search, an A → Z or by-category sort, and a grouping by category (debt securities, shares and companies, funds, your orders, the states of a line). The search at the top of the page also finds every word, and every \"i\" bubble in the app points to it.")],
            [l("Que montrent les graphiques d'un fonds ?", "What do a fund's charts show?"), l("Cinq lectures des mêmes VL publiées : la VL elle-même ; le rendement annualisé (à chaque date, ce que les 3, 6 ou 12 mois précédents ont rapporté, ramené à l'année, à côté du dernier bon du Trésor) ; 1 000 000 FCFA placés (ce que serait devenu ce montant) ; les variations (une barre par VL, verte ou rouge) ; le repli (de combien la VL était sous son plus haut). Choisissez la période, survolez la courbe pour lire chaque point. Tout est brut, avant frais, et passé : rien n'y prédit l'avenir.", "Five readings of the same published NAVs: the NAV itself; the annualised return (at each date, what the previous 3, 6 or 12 months earned, per year, next to the latest Treasury bill); 1 000 000 FCFA invested (what that amount would have become); the changes (one bar per NAV, green or red); the drawdown (how far the NAV was below its high). Choose the period, hover the curve to read each point. Everything is gross, before fees, and past: nothing there predicts the future.")],
            [l("Que montrent les graphiques du comparateur ?", "What do the comparer's charts show?"), l("Le rendement des deux lignes sur une même règle, avec ce sur quoi chaque chiffre repose (une promesse si l'émetteur paie, un passé, un dividende au cours). Deux fonds : le même million placé dans chacun, leur rendement annualisé et leur repli sur la période commune. Deux titres de dette : le calendrier des flux : ce que vous payez, ce qui revient et quand. Un fonds face à un titre : le passé de l'un, la promesse de l'autre, sur la même durée. Chaque graphique porte un encadré « Comment lire ».", "Both lines' return on one ruler, with what each figure rests on (a promise if the issuer pays, a past, a dividend at the price). Two funds: the same million invested in each, their annualised return and drawdown over the common period. Two debt securities: the cash-flow calendar : what you pay, what comes back and when. A fund against a security: the past of one, the promise of the other, over the same length of time. Each chart carries a \"How to read\" box.")],
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "flow", steps: [l("Reçue", "Received"), l("Confirmée avec vous", "Confirmed with you"), l("Transmise", "Transmitted"), l("Servie ou non servie", "Served or not served"), l("Réglée", "Settled")] },
        {
          ...
          head: [l("Question", "Question"), l("Réponse", "Answer")],
          rows: [
            [l("Pourquoi un code WhatsApp avant d'envoyer ?", "Why a WhatsApp code before sending?"), l("Une intention part quand vos deux canaux sont prouvés : l'e-mail par votre connexion, le numéro WhatsApp par un code à six chiffres reçu dessus, une seule fois. Ainsi l'accusé de réception, le rappel du conseiller et le bulletin arrivent bien à vous.", "An intention leaves once both your channels are proven: the e-mail by your sign-in, the WhatsApp number by a six-digit code received on it, once. That way the acknowledgement, the adviser's call-back and the order form do reach you.")],
            [l("Puis-je commencer sans compte ?", "Can I start without an account?"), l("Oui. Sur la fiche, donnez votre e-mail : le code reçu vous connecte et crée votre espace au passage. Ou écrivez-nous sur WhatsApp : le desk répond avec la ligne et un lien qui reconnaît votre numéro ; ouvert depuis votre téléphone, il ne vous demande plus que le code e-mail.", "Yes. On the line's page, give your e-mail: the code received signs you in and creates your space on the way. Or write to us on WhatsApp: the desk answers with the line and a link that recognises your number; opened from your phone, it only asks for the e-mail code.")],
            [l("À quoi sert mon profil financier ?", "What is my financial profile for?"), l("Sept questions, deux minutes, dans Mon espace › Mon profil : votre horizon, ce que vous cherchez, ce que vous supportez de perdre, ce que vous connaissez, la part de votre épargne, votre réserve, vos revenus. Il en sort un profil (prudent, équilibré, dynamique) et quatre mesures. Sur chaque fiche, un mot vous dit si la ligne est dans votre horizon ; une intention hors profil vous demande de le confirmer, et le conseiller le sait. Ce n'est jamais un conseil, et aucune ligne ne vous est cachée.", "Seven questions, two minutes, in My space › My profile: your horizon, what you look for, what you can bear to lose, what you know, the share of your savings, your reserve, your income. Out of it comes a profile (cautious, balanced, dynamic) and four measures. On every line's page a word tells you whether the line is within your horizon; an intention outside your profile asks you to confirm it, and the adviser knows. It is never advice, and no line is hidden from you.")],
