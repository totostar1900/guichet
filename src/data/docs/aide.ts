      ...
      blocks: [
        {
          ...
          rows: [
            ...
            [l("Où sont l'aide, le contact et les réglages ?", "Where are help, contact and settings?"), l("Derrière le « ⋮ » en haut à droite, sur chaque page : écrire sur WhatsApp (depuis une fiche, le message part avec le nom de la ligne), appeler, écrire un e-mail ; revoir « Guichet en trente secondes » et les premiers pas, ouvrir l'Aide ou le Guide, rejouer les repères de la page ; la langue, l'affichage des cartes, les alertes ; Sécurité et Se déconnecter une fois connecté. Le « ··· » d'une ligne, lui, ne parle que de cette ligne.", "Behind the \"⋮\" at the top right, on every page: write on WhatsApp (from a line's page, the message leaves with the line's name), call, write an e-mail; watch \"Guichet in thirty seconds\" and the first steps again, open the Help or the Guide, replay the page's landmarks; the language, the card display, the alerts; Security and Sign out once signed in. A line's \"···\" speaks only of that line.")],
