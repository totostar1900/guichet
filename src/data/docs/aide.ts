      ...
      blocks: [
        {
          ...
          rows: [
            ...
            [l("Par où commencer si je ne connais rien au marché ?", "Where do I start if I know nothing about the market?"), l("Le Guide propose deux parcours. « Lire une ligne en trente secondes » : huit leçons de deux minutes pour comprendre une fiche. « Comprendre le marché CEMAC » : cinq sections repliables et vingt leçons, le marché et ses acteurs, les instruments, les risques, passer un ordre, fiscalité et frais, chacune avec un schéma ou un bloc à manipuler, une question, et les mots du glossaire. Le parcours retient où vous en êtes.", "The Guide offers two courses. \"Reading a line in thirty seconds\": eight two-minute lessons to understand a line's page. \"Understanding the CEMAC market\": five folding sections and twenty lessons, the market and its actors, the instruments, the risks, placing an order, tax and fees, each with a diagram or a block to play with, a question, and the glossary words. The course remembers where you are.")],
