      ...
      blocks: [
        {
          ...
          rows: [
            ...
            [l("Quels gestes sur le téléphone ?", "Which gestures on the phone?"), l("Sur une fiche, glissez vers la gauche ou la droite pour passer à la ligne suivante ou précédente de votre liste ; les flèches « Précédente » et « Suivante » font pareil. Sur la liste des titres, glissez vers la gauche pour passer aux fonds, et inversement. Les deux icônes à droite du tri choisissent des cartes détaillées ou compactes. Le « ··· » d'une ligne ouvre ses actions : voir la fiche, suivre, comparer, partager le lien, copier l'ISIN. Sur la page des fonds, le bouton « Filtrer · Trier » en bas ramène les filtres sans remonter. Une feuille se ferme en la tirant vers le bas ou en touchant à côté.", "On a line's page, swipe left or right to move to the next or previous line of your list; the \"Previous\" and \"Next\" arrows do the same. On the securities list, swipe left to reach the funds, and back. The two icons beside the sort choose detailed or compact cards. The \"···\" of a line opens its actions: view details, follow, compare, share the link, copy the ISIN. On the funds page, the \"Filter · Sort\" button at the bottom brings the filters back without scrolling up. A sheet closes when pulled down or when you tap beside it.")],
          ],
        },
      ],
    },
