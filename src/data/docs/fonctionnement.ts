      ...
      blocks: [
        { type: "lead", text: l("Le site est en français et en anglais (bouton FR · EN), sur téléphone comme sur ordinateur. Cinq sections, et un espace personnel une fois connecté.", "The site is in French and English (FR · EN button), on phone and desktop. Five sections, and a personal space once signed in.") },
        {
          ...
          rows: [
            ...
            [l("Guide", "Guide"), l("Le glossaire, huit leçons de deux minutes, le simulateur d'obligation, le comparateur (deux lignes côte à côte, puis des graphiques adaptés à la paire, chacun avec son « Comment lire »), une recherche ; « Premiers pas » rejouable.", "The glossary, eight two-minute lessons, the bond simulator, the comparer (two lines side by side, then charts fitted to the pair, each with its \"How to read\"), a search; replayable first steps.")],
