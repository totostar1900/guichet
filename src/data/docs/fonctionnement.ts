  ...
  chapters: [
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "p", text: l("Sur chaque fiche de ligne, le client trouve les mêmes quatre volets : Essentiel (le chiffre qui compte, où en est la ligne, ce que dit le bulletin), Chiffres (l'estimation pour son montant, l'historique), Documents, Émetteur (qui emprunte, d'après les fiches BVMAC et ses propres documents, avec ses autres lignes). Les risques se lisent dans le Guide, leçon « Les quatre risques » ; le bouton « i » explique chaque terme en une phrase. Sur téléphone, l'intention se déclare sur sa propre page, ouverte par la barre du bas ; sur grand écran, dans la colonne de droite.", "On every line page the client finds the same four panes: Essentials (the figure that matters, where the line stands, what the bulletin says), Figures (the estimate for their amount, the history), Documents, Issuer (who borrows, from the BVMAC fiches and its own documents, with its other lines). Risks are read in the Guide, lesson \"The four risks\"; the \"i\" button explains each term in one sentence. On a phone, the intention is declared on its own page, opened by the bottom bar; on a large screen, in the right column.") },
        { type: "p", text: l("Le « ⋮ » en haut à droite, sur chaque page et pour tout le monde : côté client, joindre un conseiller (WhatsApp, appel, e-mail), revoir les deux animations d'accueil, l'Aide, le Guide, les repères de la page, la langue, l'affichage des cartes, les alertes, Sécurité, Se déconnecter ; côté desk, la visite guidée, le Guide sur la page courante, la Documentation, « Ce que voit le client », la langue, Se déconnecter. Le « ··· » or d'une ligne ne concerne que la ligne.", "The \"⋮\" at the top right, on every page and for everyone: on the client side, reaching an adviser (WhatsApp, call, e-mail), watching the two welcome animations again, the Help, the Guide, the page's landmarks, the language, the card display, the alerts, Security, Sign out; on the desk side, the guided tour, the Guide on the current page, the Documentation, \"What the client sees\", the language, Sign out. A line's gold \"···\" concerns the line only.") },
        { type: "p", text: l("Le profil financier (Mon espace › Mon profil) : sept questions, un profil prudent / équilibré / dynamique, quatre mesures (horizon, tolérance, connaissance, capacité), gardés sur le profil du client (colonne financial_profile). La fiche d'une ligne porte « dans votre horizon » ou « au-delà de votre horizon » ; une intention hors profil est confirmée par le client (case à cocher) et arrive au desk avec la mention « Hors profil, confirmé par le client ». C'est l'adéquation que demande la COSUMAF ; jamais un conseil, jamais une ligne cachée.", "The financial profile (My space › My profile): seven questions, a cautious / balanced / dynamic profile, four measures (horizon, tolerance, knowledge, capacity), kept on the client's profile (financial_profile column). A line's page carries \"within your horizon\" or \"beyond your horizon\"; an intention outside the profile is confirmed by the client (a box to tick) and reaches the desk with the mention \"Outside the profile, confirmed by the client\". It is the suitability COSUMAF asks for; never advice, never a hidden line.") },
        { type: "p", text: l("La connexion se fait par un code reçu par e-mail : pas de mot de passe. Un client peut ensuite ajouter son appareil (Mon espace › Sécurité) : la serrure du téléphone (clé d'accès : Face ID, empreinte, code du téléphone) ou un code à quatre chiffres lié à ce navigateur ; l'appareil connu ouvre alors d'abord, le code e-mail reste dessous. Chaque ajout et retrait est annoncé au client sur ses deux canaux et inscrit au journal. Sur téléphone, une barre en bas donne Guichet, Fonds, Mon espace, Info, et l'icône journal ouvre les actualités.", "Sign-in is a code received by e-mail: no password. A client can then add their device (My space › Security): the phone's lock (passkey: Face ID, fingerprint, the phone's code) or a four-digit code bound to that browser; the known device then opens first, the e-mail code stays below. Every addition and removal is announced to the client on both channels and written to the journal. On a phone, a bottom bar gives Guichet, Funds, My space, Info, and the newspaper icon opens the news.") },
      ],
    },
    {
      id: "desk",
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "note", kind: "rule", text: l("Une intention part avec ses deux canaux prouvés. L'e-mail est prouvé par la connexion ; le numéro WhatsApp par un code à six chiffres envoyé dessus et saisi dans le formulaire, une seule fois par numéro (dix minutes, cinq essais). Un invité donne son e-mail sur la fiche : le code le connecte et crée son espace. Un nouveau numéro ou une nouvelle adresse perd sa preuve. La fiche de l'intention montre ces marques au desk.", "An intention leaves with both its channels proven. The e-mail is proven by the sign-in; the WhatsApp number by a six-digit code sent to it and typed in the form, once per number (ten minutes, five tries). A guest gives their e-mail on the line's page: the code signs them in and creates their space. A new number or a new address loses its proof. The intention's page shows these marks to the desk.") },
        ...
        { type: "diagram", kind: "documents", caption: l("La chaîne documentaire d'un ordre, du premier accusé au relevé.", "The document chain of an order, from the first acknowledgement to the statement.") },
      ],
    },
    {
      id: "dossier",
    ...
    },
    {
      ...
      blocks: [
        ...
        { type: "p", text: l("Depuis Messages, « Répondre avec la ligne » joint la fiche à la réponse ; sur WhatsApp, le lien est signé pour ce numéro pendant trente jours : le client qui l'ouvre depuis son téléphone a son numéro reconnu, et son intention ne lui demande plus que le code e-mail. C'est l'entrée sans compte d'un client qui a d'abord écrit sur WhatsApp.", "From Messages, \"Answer with the line\" attaches the line's page to the reply; on WhatsApp the link is signed for that number for thirty days: the client who opens it from their phone has their number recognised, and their intention only asks for the e-mail code. It is the account-less way in for a client who wrote on WhatsApp first.") },
