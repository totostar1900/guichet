    ...
    <>
      ...
      <div className="panel">
        ...
        <div style={{ padding: "12px 16px", fontSize: ".85rem", color: "var(--ink-2)", maxWidth: "80ch" }}>
          <p>
            <b>{t("Seul :")}</b> définitions (rendement actuariel, coupon couru, in fine, adjudication…), caractéristiques exactes des offres publiées, chiffrage d&apos;un montant, dates, état des intentions et documents du client, ouverture de compte, enregistrement d&apos;un appétit, d&apos;une question ou d&apos;un rappel. STOP / START gèrent l&apos;opt-in.
          </p>
          <p>
