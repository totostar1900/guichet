  ...
  if ((o.kind === "OTA" || o.kind === "APE") && o.couponRate != null && o.maturityOn) {
    ...
    return {
      ...
      rows: [
        ...
        [dy.atPar ? "Taux nominal (au pair)" : "Rendement actuariel brut", fmtPct(dy.atPar ? (o.couponRate ?? r.irr) : r.irr, 2)],
      ],
      flows: r,
      settleOn: o.settleOn,
    };
    ...
    if ((ai && ai.maturityOn > ai.settleOn) || (bi && bi.maturityOn > bi.settleOn)) {
      ...
      return {
        ...
        rows: [
          ...
          [dy.atPar ? "Taux nominal (au pair)" : "Rendement actuariel brut à ce cours", fmtPct(dy.atPar ? (o.couponRate ?? r.irr) : r.irr, 2)],
        ],
        flows: r,
        settleOn,
      };
