...
export const GLOSSARY = {
  ...
  indice: { short: "Indice BVMAC", long: "BVMAC All Share Index", text: "Un seul nombre pour toutes les actions cotées : une somme de capitalisations ramenée à une base, publiée chaque séance par la BVMAC. Il vaut par sa variation ; sept valeurs, dont une pèse les trois quarts ; les dividendes n'y sont pas." },
  ...
  // the actors of the market, one entry each: the map of the actors and the lessons open them in a popup
  beac: { short: "BEAC", long: "Banque des États de l'Afrique centrale", text: "La banque centrale commune aux six États de la CEMAC : elle émet le franc CFA, fixe son taux directeur et tient le marché des titres publics, où les Trésors adjugent leurs BTA et OTA par l'intermédiaire des SVT." },
  cosumaf: { short: "COSUMAF", long: "Commission de surveillance du marché financier de l'Afrique centrale", text: "Le régulateur du marché financier régional : elle agrée les sociétés de bourse (dont Purpose Capital), vise les appels publics à l'épargne et les fonds, et veille à ce que chacun respecte les règles. Son agrément vous dit que l'intermédiaire est contrôlé." },
  bvmac: { short: "BVMAC", long: "Bourse des valeurs mobilières de l'Afrique centrale", text: "La bourse régionale, à Douala : c'est là que se cotent les actions et les obligations déjà émises, séance après séance, et qu'est publié chaque soir le Bulletin officiel de la cote que le Guichet reprend." },
  depositaire: { short: "Dépositaire", text: "L'organisme qui tient le registre des titres : chaque titre que vous achetez y est inscrit à votre nom, dans votre compte-titres. Vos titres et votre argent y restent quand vous changez d'intermédiaire ; le Guichet vous en transmet les relevés." },
  tresor: { short: "Trésor public", text: "La direction du ministère des Finances qui emprunte pour l'État : il émet les BTA et les OTA par adjudication à la BEAC, verse les coupons et rembourse à l'échéance. Chaque État de la CEMAC a le sien." },
  gestion: { short: "Société de gestion", text: "La société agréée par la COSUMAF qui gère un fonds (OPCVM) : elle choisit les placements, calcule et publie la valeur liquidative, et exécute vos souscriptions et rachats de parts." },
  societe_bourse: { short: "Société de bourse", text: "L'intermédiaire agréé par la COSUMAF qui reçoit vos ordres et les porte au marché : Purpose Capital est votre société de bourse. Elle vous conseille, transmet vos intentions au SVT, à la BVMAC ou à la société de gestion, et vous rend compte à chaque étape." },
  emetteur: { short: "Émetteur", text: "Celui qui emprunte ou ouvre son capital : un État (BTA, OTA), une entreprise (obligation par APE, introduction en bourse). Il paie les coupons ou les dividendes et rembourse l'obligation à l'échéance." },
  compte_titres: { short: "Compte-titres", text: "Le compte ouvert à votre nom chez le dépositaire, par l'intermédiaire de Purpose Capital, où sont inscrits vos titres. Mon espace vous en montre le contenu ; les relevés vous sont adressés à chaque mouvement." },
  rachat: { short: "Rachat", text: "Le Trésor reprend ses propres titres avant l'échéance, en général au pair : une opération annoncée comme une ligne, où vous présentez les titres que vous détenez. Pour un fonds, le rachat est la revente de vos parts à la société de gestion, à la prochaine VL." },
  introduction: { short: "Introduction en bourse", text: "Une société ouvre son capital au public : ses actions sont offertes à un prix de souscription pendant une fenêtre, avec le visa de la COSUMAF, puis cotées à la BVMAC." },
