...
- [Supabase migrations](guichet-supabase-migrations.md) : applied via Chrome SQL editor with window.monaco setValue; enum adds run alone; 0001–0032 applied (0023 funds open, 0024 inbox, 0025 news, 0026 channels+devices, 0027 terms, 0028 financial profile, 0029 prefs)
