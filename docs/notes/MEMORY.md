...
- [Phone UX](guichet-phone-ux.md) : fiche swipe, card pull (left = Déclarer · Me rappeler, right = the adaptive light back: calendar/curve + reference), « ··· » sheet, layout D, density + distinction settings, floating filter/chevron, share image; guide shots stale
